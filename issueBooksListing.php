        ...
        <table class='table table-striped'>
            ...
            if(isset($data))
            {
                ...
                <tr>
                    ...
                    <td><?php echo 'user_id: '. $row['issued_to'];?></td>
                    <td>
                        ...
                        {
                            $book_id = $row['id'];
                            echo "<button id='issueBook'><a href='issueBooks.php?id=$book_id'>Issue</a></button>";
                        }
                        else
                        {
                            echo "<button id='issuedBook'>Already Issued</button>";
                        }
                        ?>
                    </td>
                </tr>
