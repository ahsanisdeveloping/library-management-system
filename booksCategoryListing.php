<?php 
    ...
    $query = 'SELECT * FROM bookcatergories';
...
<body>
    ...
    <div class="navbar bg-dark"><button class='button bg-primary text-white p-2'>
            <a class='text-white' href="booksCategoryInsertion.php">Add Categories</a>
        </button></div>
    <table class='table table-striped'>
        ...
        <tr>
            ...
            <td><button class='button bg-success text-white border p-2'><?php echo $row['status'];?></button></td>
            <td><?php echo $row['created_at'];?></td>
            <td><?php echo $row['updated_at'];?></td>
            <td>
                <button class='button p-1 border bg-primary text-white'><a href="#" class='text-white'>Edit</a></button>
                <button class='button border  bg-danger p-1 text-white'><a class='text-white'
                        href="booksCategoryDeletion.php?id=<?php echo $row['id']; ?>">Delete</a></button>
            </td>
        </tr>
        <?php endforeach;}?>
    </table>
